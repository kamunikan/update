...
DIGI="vless://${uuid}@162.159.134.61:$none?path=/vlessws%26host=${domain}%26encryption=none%26type=ws#${user}"
MAXIS="vless://${uuid}@who.int:$tls?path=wss://who.int/vlessws%26security=tls%26host=${domain}%26encryption=none%26type=ws%26sni=who.int#${user}"
UMOBILE="vless://${uuid}@ulist.com.my.${domain}:$tls?path=/vlessws%26security=tls%26encryption=none%26type=ws%26sni=ulist.com.my#${user}"
GRPC="vless://${uuid}@${domain}:$tls?mode=gun%26security=tls%26encryption=none%26type=grpc%26serviceName=vless-grpc%26sni=bug.com#${user}"
