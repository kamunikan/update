...
vmesslink4="vmess://$(echo $DIGI80 | base64 -w 0)"
vmesslink5="vmess://$(echo $MAXIS443 | base64 -w 0)"
vmesslink6="vmess://$(echo $UMOBILE443 | base64 -w 0)"
systemctl restart xray > /dev/null 2>&1
