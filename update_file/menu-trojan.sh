...
function addtrojan(){
source /var/lib/scvpn-pro/ipvps.conf
...
DIGI="trojan://${uuid}@162.159.134.61:80?path=%2Ftrojan-ws%26security=none%26host=${domain}%26type=ws#${user}"
MAXIS="trojan://${uuid}@who.int:${tr}?path=%2Ftrojan-ws%26security=tls%26host=${domain}%26type=ws%26sni=who.int#${user}"
UMOBILE="trojan://${uuid}@ulist.com.my.${domain}:${tr}?path=%2Ftrojan-ws%26security=tls%26host=ulist.com.my%26type=ws%26sni=ulist.com.my#${user}"
...
TEXT="<b> 💬 NOTIFACTION</b>
 🔸 TROJAN WS Accound Info
<b>━━━━━━━━━━━━━━━━</b>
<b>◾️ Username</b> : <code>${user}</code>
<b>◾️ Expired On</b> : <code>$exp</code>
<b>━━━━━━━━━━━━━━━━</b>
<b>🟨 DIGI NON TLS : </b>
<code>${DIGI}</code>
