...
<b>━━━━━━━━━━━━━━━━</b>
  ...
  <b>OpenSSH</b> : <code>$opensh</code>
  <b>Dropbear</b> : <code>$db</code>
  <b>SSH-WS</b> : <code>$portsshws</code>
  <b>SSH-SSL-WS</b> : <code>$wsssl</code>
  <b>SSL/TLS</b> :<code>$ssl</code>
  <b>UDPGW</b> : <code>7100-7300</code>
<b>━━━━━━━━━━━━━━━━</b> 
  <b>Payload : </b>
  <code>GET wss://bug.com/ HTTP/1.1[crlf]Host: [host][crlf]Upgrade: websocket[crlf]Connection: keep-alive[crlf][crlf]</code>
<b>━━━━━━━━━━━━━━━━</b>
<i> 🕧 $bcc</i>"
...
wget -q -O /usr/bin/proxy3.js "https://raw.githubusercontent.com/kamunikan/multiws/main/ssh/proxy3.js"
cat <<EOF > /etc/systemd/system/sshws.service
[Unit]
Description=WSenabler
Documentation=https://dotycat.com
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}" 
wget -q -O /usr/bin/ssh-wsenabler "https://raw.githubusercontent.com/kamunikan/SSHWS-DATA/main/ssh-wsenabler" && chmod +x /usr/bin/ssh-wsenabler
...
Login=scvpn`</dev/urandom tr -dc X-Z0-9 | head -c4`
hari="1"
Pass=1
