...
~/.acme.sh/acme.sh --installcert -d $domain --fullchainpath /root/.acme.sh/v6.scvpn.me_ecc/fullchain.cer --keypath /root/.acme.sh/v6.scvpn.me_ecc/v6.scvpn.me.key --ecc
